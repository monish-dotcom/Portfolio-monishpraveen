          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <ul className="flex space-x-8">
                ...
                <li>
                  <a className="text-white hover:text-blue-200  px-3 py-2 rounded-md text-sm font-medium">
                    Skills
                  </a>
                </li>
                <li>
        ...
        {isMenuopen && (
          <div className="md:hidden bg-gradient-to-b from-red-600 via-purple to-blue-600">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a className="text-white hover:text-blue-400 block px-3 py-2 rounded-md transition-color duration-200">
                About
              </a>
              <a className="text-white hover:text-blue-400 block px-3 py-2 rounded-md transition-color duration-200">
                Skill

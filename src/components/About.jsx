    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center space-y-8 mb-16">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-red-600 via-purple-600 to-blue-500 bg-clip-text text-transparent">
        ...
        <div className="relative flex justify-center mb-16">
          ...
          <img
            src="https://matchingpfp.us/wp-content/uploads/Cool-PFP-27.jpg"
            alt="Profile"
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-16">
          ...
          <div className="space-y-6 text-left max-w-4xl mx-auto">
            <p className="text-lg text-gray-600">
              I started my journey in web development back in 2024, My expertise
              spans across the entire web development stack, from crafting
